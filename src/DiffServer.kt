...
class DiffServer {
        ...
        val server = embeddedServer(Netty, port = 8080) {
            ...
            routing {
                ...
                post("/add") {
                    ...
                    try {
                        require(
                            params.contains("author_id") && params.contains("text")
                        ...
                        db.addDocument(
                            text = params["text"]!!,
                            author_id = params["author_id"]!!.toInt(),
                            document_id = params["document_id"]!!.toInt(),
                            original = db.isDocumentExists(params["document_id"]!!.toInt())
                        )
                        call.respond(mapOf("respond" to "OK"))
                    } catch (e: IllegalArgumentException) {
                        call.respond(mapOf("respond" to "error", "result" to "one or more parameters are missing"))
                    }
                }
                ...
                get("/dummy") {
                    ...
                    val df = Differ()
                    val edited = mapOf<Int, String>(
                        2 to "  So she was considering in her own mind (as well as she could, for the hot day made her feel very sleepy and stupid), whether the pleasure of making a daisy-chain would be worth the trouble of getting up and picking the daisies, when suddenly a White Rabbit with pink eyes ran close by her.\n" +
    ...
    fun addDocs() {
        ...
        db.addDocument(
            author_id = 7, document_id = 11, text = "Ya sverhu.\n" +
